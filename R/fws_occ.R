...
#'
#' @param fws \code{data.frame} of organizational names (ORGNAME) of USFWS
#'  properties meeting the search criteria and their associated USFWS region
#'  (FWSREGION), within and around which the user wishes to extract species
#'  occurrence records.  It is strongly recommended to use the results
#'  generated by \code{\link{find_fws}} to ensure proper formatting. See
#'  examples.
