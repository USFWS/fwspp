...
#'
#' @param prop_df \code{data.frame} of organizational names (ORGNAME) of USFWS
#'  properties and their associate USFWS region. It is strongly recommended
#'  to use the results generated by \code{\link{find_fws}} to ensure proper
#'  formatting.
...
prep_properties <- function(prop_df, bnd, verbose) {
  ...
  # Filter
  props <- semi_join(r, prop_df, by = c("ORGNAME", "FWSREGION"))
