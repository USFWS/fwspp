[![Build
Status](https://travis-ci.org/adamdsmith/fwspp.png)](https://travis-ci.org/adamdsmith/fwspp)
...
maintained by the USFWS as part of their (currently internal only)
[FWSpecies database](https://ecos.fws.gov/FWSpecies). Note that this
...
“category” (e.g., Mammals, Birds, Fungi) designated by the USFWS are
returned. Modifications to observation taxonomy can be suppressed with
`taxonomy = FALSE`. FWSpecies is modelled heavily on the National Park
Service’s (NPS) [NPSpecies database](https://irma.nps.gov/NPSpecies)
